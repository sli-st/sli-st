    ...
    >
      <div className="row justify-content-center g-0">
        <div className="col-md-5 d-flex justify-content-between align-items-center">
          <Link to="/s" className="text-white border border-white text-decoration-none px-2 mt-1">
            S
          </Link>


          <Link to="/adventures/" className="text-white">
          ...
          <Link to="/" className="text-primary text-decoration-none border border-primary px-2 mt-1">
            SLi.ST
          </Link>

          <Link to="/perks" className="text-white">
