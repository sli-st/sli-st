        ...
        <div className="row justify-content-center sticky-top">
          <div className="col-md-5">
            ...
            <nav className="bg-black pt-3 pb-3 border-bottom border-primary">
              <div
                className="nav nav-justified gap-2 mx-auto d-md-flex justify-content-md-center"
                id="nav-tab"
                role="tablist"
              >
                <button
                ...
                <button
                  className="nav-link btn btn-outline-light text-decoration-none active text-light"
                  id="nav-profile-tab"
                  data-bs-toggle="tab"
                ...
                >
                  <section>
                    ...
                    <div className="row justify-content-center g-0">
                      <div className="col-11 col-md-8 rerow d-flex flex-wrap flex-row justify-content-center align-items-center p-0"></div>
                    </div>
                  </section>
                </div>
                <div
