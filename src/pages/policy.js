...
const IndexPage = () => (
  <Layout>
    ...
    <section>
      <h1 className="text-center display-2 mb-6 mt-7">Event Sharing Policy</h1>
            ...
            >
              <div className="card card-sm card-body bg-primary border-light mb-0">
                ...
                <div className="collapse" id="panel-1">
                  <div className="pt-3">
                    <p>
                      The goal is to share as many underground events with as
                      many people as possible. Even if I don't like a particular
                      venue, event, or organization, I will share their event
                      with the rest of the community. Everyone should be able to
                      make their own opinions, judgements, and choices. As a
                      self-proclaimed semi-professional event-sharer I cannot
                      become a curator for the general project. I will bring
                      this up to a vote if an issue ever arrises that calls for
                      me to stop sharing events from a venue or organization for
                      some crime against the community. Use your imagination, or
                      ask me what I mean.
                    </p>
                    <p>
                      ...
                      events. There's a few people that appreciate that and
                      count on me for that list so I will continue to share my
                      personal curated S List of events alongside everything
                      else.
                    </p>
                  </div>
                </div>
              ...
              <div className="card card-sm card-body bg-primary border-light">
                ...
                >
                  <span className="h6 mb-0 font-weight-bold">
                    I will always be open to suggestions, feedback, and
                    criticism.
                  </span>
                  <FontAwesomeIcon icon={faPlus} className="icon" />
                </a>
                <div className="collapse" id="panel-3">
                  <div className="pt-3">
                    <p className="mb-0">
                      ...
                      events has been voted on. I appreciate the nuanced
                      opinions and feedback and I will always rely on the
                      community for your perspective.
                    </p>
                  </div>
                </div>
              </div>
