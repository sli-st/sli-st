...
const IndexPage = ({ data }) => (
  <Layout pageTitle="Index" to="/about" label="About">
    <Seo title="Index" />
    <nav className="md:px-36 lg:px-60 xl:px-80 text-secondary text-center uppercase flex flex-row justify-between pt-10 space-x-5">
          ...
          <div className="grid gap-8 items-start justify-center">
            <div className="relative group ">
              ...
              <a
                ...
                className="relative px-7 py-4 bg-background rounded-lg leading-none flex items-center divide-x divide-gray-600 w-full mx-0"
              >
                <span className="flex items-center space-x-5">
                  ...
                  <span className="pr-6 text-secondary">Share Flyers</span>
                </span>
                <span className="pl-6 text-primary group-hover:text-secondary transition duration-200">
                  @slistxmas &rarr;
                </span>
              </a>
            </div>
