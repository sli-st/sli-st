  ...
  <Layout>
    ...
    <div className="container-fluid text-start py-5 ">
      <section className="row justify-content-center">
        <div className="col-11 col-md-6 py-3">
          <SignUpForm />
        </div>
      </section>
      ...
      <section className="row justify-content-center">
        <div className="col-11 col-md-6 pt-3 pb-5 mb-5 text-white">
          <p className="text-secondary">OCT 21 5am: Big update. Playing with colors. Higher contrast with red. Membership registrations are finally open. New sections. 50+ flyers added today. Analytics looking good. More users everyday. Some people are actually reading some of this stuff xoxo.</p>
