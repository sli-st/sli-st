        ...
        <div className="pt-16 col-span-4 ">
          <div className="grid gap-8 items-start justify-center">
            <div className="relative group ">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-secondary to-primary rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt text-xs md:text-base"></div>
              <a
                href="https://instagram.com/slistxmas"
                className="relative px-3 px-md-7 py-4 bg-background rounded-lg leading-none flex items-center divide-x divide-gray-600 w-full mx-0"
              >
                <span className="flex items-center space-x-3 md:space-x-5">
                  ...
                  <span className="pr-3 md:pr-6 text-secondary">
                    Find Flyers
                  </span>
                </span>
                <span className="pl-3 md:pl-6 text-primary group-hover:text-secondary transition duration-200">
                  @slistxmas &rarr;
                </span>
              </a>
            </div>
